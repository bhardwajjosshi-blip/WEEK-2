...
SELECT course, Count(*) FROM student1 GROUP BY course;

SELECT * FROM student1 ORDER BY age DESC LIMIT 1;

SELECT * FROM student1 ORDER BY age ASC LIMIT 1;

SELECT * FROM student1 WHERE name LIKE '%E%';